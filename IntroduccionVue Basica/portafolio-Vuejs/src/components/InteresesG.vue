...
const intereses = ref([
    'Deportes: Disfruto del running y el futbol, actividades que practico regularmente para mantener un equilibrio entre el trabajo y la vida personal.',
    'Aficionado a los juegos de estrategia: Me apasionan los videojuegos de estrategia, ya que estimulan habilidades como la planificación, la toma de decisiones y el pensamiento crítico, que aplico en mi trabajo diario.',
    'Tecnología y Gadgets:: Me apasiona explorar nuevas tendencias tecnológicas como la inteligencia artificial y el desarrollo de aplicaciones móviles.',
    'Aficionado a los Viajes Culturales: Me apasiona viajar y descubrir nuevas culturas. Esta experiencia me ha ayudado a desarrollar una mentalidad abierta, adaptabilidad y la capacidad de trabajar con personas de distintos contextos.'
]);
</script>
