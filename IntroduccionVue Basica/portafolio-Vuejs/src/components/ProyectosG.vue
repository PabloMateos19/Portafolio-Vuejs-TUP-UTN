<script setup>
import proyecto1 from '/src/assets/proyecto1.jfif';
import proyecto2 from '/src/assets/proyecto2.jfif';
import proyecto3 from '/src/assets/proyecto3.jfif';
import proyecto4 from '/src/assets/proyecto4.jfif';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Aplicación Web de Gestión de Tareas",
        descripcion: "App web para gestionar tareas con funciones de registro, inicio de sesión y CRUD de tareas.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/PabloMateos19"
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Aplicación Móvil de Seguimiento de Hábitos",
        descripcion: "App móvil para seguir hábitos diarios y visualizar el progreso.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/PabloMateos19"
    },
    {
        ...
        descripcion: "Sistema que recomienda películas basadas en preferencias del usuario usando machine learning",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/PabloMateos19"
    },
    {
        ...
        descripcion: "Plataforma web para compra y venta de productos con gestión de inventario y pedidos.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/PabloMateos19"
    },
])
