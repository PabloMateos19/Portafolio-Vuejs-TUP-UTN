...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion', descripcion: 'Incumbencias Profesionales: Operación y programación de computadoras, desarrollo de programas en distintos lenguajes, análisis y control de sistemas informáticos.', enlace:'https://www.frsr.utn.edu.ar/'},
  {fecha: '2019', title: 'Curso Autocad Civil 3D ', descripcion: 'Desarrollé un proyecto de diseño de carretera de Montaña en AutoCad Civil 3D', enlace:'https://www.udemy.com/'},
  {fecha: '2018', title: 'Ingeniería Industrial', descripcion: 'Cursado completo. Adeudado de 8 materias', enlace:'https://www.frsr.utn.edu.ar/'}
]);
</script>
